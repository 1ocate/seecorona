...
i_checked_off = data_off["data"]["total_spesimen"]
i_positive_off = data_off_total["jumlah_positif"]
i_cure_off = data_off_total["jumlah_sembuh"]
i_death_off = data_off_total["jumlah_meninggal"]
